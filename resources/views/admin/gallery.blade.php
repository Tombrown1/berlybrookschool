                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <div class="form-group mb-3">
                                          <label for="fname">Gallery Category</label>
                                        <select name="gallery_cat_id" value="{{$gallery->gallery_cat_id}}" class="form-control">
                                          @foreach($gallery_cats as $gallery_cat)
                                            <option value="{{$gallery_cat->id}}"{{$gallery->gallery_cat_id === $gallery_cat->id ? 'selected' : ''}}>{{$gallery_cat->name}}</option>
                                          @endforeach
                                        </select>
                                      </div>
                                      <div class="form-group mb-3">
