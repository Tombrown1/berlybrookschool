        ...
        <div class="card mt-3">
          ...
          <div class="card-body">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="logo-tab" data-toggle="tab" href="#banner" role="tab" aria-controls="banner" aria-selected="false">Banner</a>
              </li>
            </ul>
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade" id="banner" role="tabpanel" aria-labelledby="standard-tab">
                <div class="p-3">
                  <h4>Upload Banner</h4>
                </div>
                <form method="POST" action="{{route('upload.banner')}}" enctype="multipart/form-data" class="form-inline">
                  @csrf
                ...
                <div class="m-4">
                   <div class="form-group">
                        <img src="{{asset('storage/'.$setting->banner)}}" width="300" class="img-thumbnail">
                      </div>
                </div>
              </div>
            </div>
