                        ...
                        <tr>
                          ...
                          <td>
                            <form action="#" method="post">          
                              <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editboard{{$board->id}}"><i class="fa fa-edit"></i></a>                              
                            </form>
                          </td>
                           <div class="modal fade mt-5" id="editboard{{$board->id}}" tabindex="-1" role="dialog" aria-labelledby="addSessionLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                  <form method="post" class="profile-wrapper" enctype="multipart/form-data" action="{{ route('update.board', ['id' => $board->id]) }}" >
                                      {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                          <select name="board_cat_id" value="{{$board->board_cat_id}}" class="form-control">
                                            @foreach($boardcats as $board_cat)
                                                <option value="{{$board_cat->id}}" {{$board_cat->id === $board->board_cat_id ? 'selected' : ''}}>{{$board_cat->name}}</option>
                                            @endforeach
                                          </select>
                                        </div>
                                        <div class="form-group">
