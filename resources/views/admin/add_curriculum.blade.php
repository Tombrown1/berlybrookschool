...
@section('pageTitle', 'Add Curriculum')
@section('content')
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card mt-3">
            ...
            <div class="card-body">
              <form role="form" enctype="multipart/form-data" action="{{route('store.curriculum')}}" method="post" >
                  {{ csrf_field() }}
                    ...
                    <div class="col-md-10 col-sm-12 col-xs-12">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="age_range" Required/>
                      </div>                        
                      <div class="form-group">
                        <label for="disabledSelect">Select Category</label>
                        <select name="curriculum_cat_id" id="" class="form-control">
