            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">                    
                    ...
                    <li class="nav-item">
                      <a href="{{route('curriculum')}}" class="nav-link ml-3">
                        <i class="far fa-circle nav-icon"></i>
                        <p>All Curriculum</p>
                      </a>
                    </li>
                    ...
                    <li class="nav-item">
                      <a href="{{route('curriculum.category')}}" class="nav-link ml-3">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Curriculum Category</p>
                      </a>
                    </li>
              ...
              <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">                    
                    ...
                    <li class="nav-item">
                      <a href="{{route('staffs')}}" class="nav-link ml-3">
                        <i class="far fa-circle nav-icon"></i>
                        <p>All Staff</p>
                      </a>
                    </li>
                    ...
                    <li class="nav-item">
                      <a href="{{route('staff.category')}}" class="nav-link ml-3">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Staff Category</p>
                      </a>
                    </li>
