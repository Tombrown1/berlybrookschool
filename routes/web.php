...
Route::get('/admission', [PagesController::class, 'admission'])->name('site.admission');
Route::get('/curriculum', [PagesController::class, 'curriculum'])->name('site.curriculum');
Route::get('/curriculum-detail/{slug}', [PagesController::class, 'CurriculumDetail'])->name('curriculum.detail');
...
Route::get('/staff-profile/{slug}', [PagesController::class, 'StaffProfile'])->name('staff.profile');
...
{    
    ...
    Route::post('/upload-banner', [SettingsController::class, 'logoBanner'])->name('upload.banner');
    // Gallery Route
    ...
    Route::post('/create-admission', [AdmissionController::class, 'createAdmission'])->name('add.admission');
    Route::get('/edit-admission', [AdmissionController::class, 'editAdmission'])->name('edit.admission');
    Route::post('/update-admission/{id}', [AdmissionController::class, 'updateAdmission'])->name('update.admission');
    Route::post('/del-admission/{id}', [AdmissionController::class, 'deleteAdmission'])->name('del.admission');


     // Curriculum Route
    Route::get('/curriculum', [CurriculumController::class, 'index'])->name('curriculum');
    Route::get('/add-curriculum', [CurriculumController::class, 'addCurriculum'])->name('add.curriculum');
    Route::post('/store-curriculum', [CurriculumController::class, 'storeCurriculum'])->name('store.curriculum');
    Route::get('/edit-curriculum/{id}', [CurriculumController::class, 'editCurriculum'])->name('edit.curriculum');
    Route::post('/update-curriculum/{id}', [CurriculumController::class, 'updateCurriculum'])->name('update.curriculum');    

    // Curriculum Category Route
    Route::get('/curriculum-category', [CurriculumController::class, 'CurriculumCategory'])->name('curriculum.category');
    Route::post('/add-curriculum-category', [CurriculumController::class, 'CreateCategory'])->name('add.curriculum.category');

    Route::post('/delete-curriculum-category/{id}', [CurriculumController::class, 'DeleteCategory'])->name('delete.curriculum.category');

    // Staff Route
    Route::get('/staffs', [StaffController::class, 'index'])->name('staffs');
    Route::get('/edit-staff/{id}', [StaffController::class, 'editStaff'])->name('edit.staff');
    Route::post('/store-staff', [StaffController::class, 'storeStaff'])->name('store.staff');
    Route::post('/update-staff/{id}', [StaffController::class, 'updateStaff'])->name('update.staff');


    // Staff Category Route
    Route::get('staff-category', [StaffController::class, 'staffCategory'])->name('staff.category');
    Route::post('/staff-category', [StaffController::class, 'CreateCategory'])->name('add.staff.category');
